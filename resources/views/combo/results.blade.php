...
<style>
    .combo-results { max-width: 1200px; margin: 0 auto; padding: 1rem; }
    ...
    .hotel-image { width: 100%; height: 180px; object-fit: cover; border-top-left-radius: 1rem; border-top-right-radius: 1rem; }
...
<script>
    ...
    document.querySelectorAll('.flight-card').forEach(card => {
        ...
        const select = () => {
            ...
            document.getElementById('bookBtn').disabled = !(selectedFlight && selectedHotel);
        };

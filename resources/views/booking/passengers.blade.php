...
<head>
    <meta charset="UTF-8">
    <title>Passenger Details - Travelio</title>
...
<div class="container">
    <div class="card">
        <h1><i class="fa-regular fa-id-card"></i> Passenger Information</h1>
        <form method="POST" action="{{ route('booking.process.passengers') }}">
            @csrf

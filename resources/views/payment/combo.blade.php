...
<div class="payment-container">
    <div class="payment-card">
        <h1><i class="fa-regular fa-credit-card"></i> Combo Payment</h1>
        <p>Complete your flight + hotel combo booking</p>
        <div class="summary">
            <p><strong>Total:</strong> RM {{ number_format($total, 2) }}</p>
        </div>

        <form method="POST" action="{{ route('payment.combo.process') }}">
            @csrf

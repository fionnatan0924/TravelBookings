...
public function search(Request $request)
{
    ...
    $cityToCode = [
        'kuala lumpur' => 'KUL', 'kualalumpur' => 'KUL', 'kul' => 'KUL', 'kl' => 'KUL',
        'penang' => 'PEN', 'pen' => 'PEN', 'johor bahru' => 'JHB', 'jhb' => 'JHB', 'johor' => 'JHB',
        'langkawi' => 'LGK', 'lgk' => 'LGK', 'guangzhou' => 'CAN', 'can' => 'CAN',
        'singapore' => 'SIN', 'sin' => 'SIN', 'bangkok' => 'BKK', 'bkk' => 'BKK',
        'hong kong' => 'HKG', 'hkg' => 'HKG', 'tokyo' => 'NRT', 'nrt' => 'NRT', 'hanoi' => 'HAN', 'han' => 'HAN',
    ];
    ...
    if ($tripType === 'multi') {
        ...
        foreach ($request->multi_segments as $segment) {
            ...
            $flights = Flight::where('origin', $fromCode)
                ...
                ->get();
            $results[] = ['segment' => $segment, 'flights' => $flights];
        }
